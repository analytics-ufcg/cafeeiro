...
function showParallelCoord(data) {
  ...
  var div_width = 800; //$("#atts_analysis #central_bar #atemporal_pane").width(),
      div_height = 500; //$("#atts_analysis #central_bar #atemporal_pane").height();
  ...
  var svg = d3.select("#atts_analysis #central_bar #atemporal_pane").append("svg:svg")
          .attr("width", div_width + m.left + m.right) //"100%")
          .attr("height", div_height + m.top + m.bottom) //"100%")
      .append("svg:g")
